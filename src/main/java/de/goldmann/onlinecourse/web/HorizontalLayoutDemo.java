...
public class HorizontalLayoutDemo  extends VerticalLayout {
    public HorizontalLayoutDemo() {
        ...
        // 3
        // Create buttons
        Button button1 = createBtn("One");
        Button button2 = createBtn("One");
        Button button3 = createBtn("One");
        ...
        Button changeBtn = createBtn("Apply Changes");
